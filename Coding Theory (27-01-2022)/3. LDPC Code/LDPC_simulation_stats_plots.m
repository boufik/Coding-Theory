function [H, num_variables, num_checks, num_edges, rate_expected, counter_tries, initial_errors, final_errors]= LDPC_simulation_stats_plots(n, l_optimum, r_optimum, PROCESS)
...
%     result2 = linprog(f2, A2, B2 , Aeq, Beq, lb, ub);
    ...
    if PROCESS == "find_appropriate_n"
        %% FOR SIMULATIONS PURPOSE - DELETED LATER
        H = 1;
        num_variables = NaN;
        num_checks = NaN;
        disp("Possible solution found - exit code 3")
        return
